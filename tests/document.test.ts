...
describe('document', () => {
  it('creates pure documents and round-trips all node types and the blank condition', () => {
    const d = create(); d.nodes = [
      { id: 'r', type: 'rect', rect, fill: '#ffffff', shape: 'star' },
      { id: 't', type: 'text', rect, text: 'Hello', fontSize: 40, weight: 700, align: 'center', color: '#000000', font: 'kylora' },
  ...
  it('rejects malformed nodes, geometry, colours, fonts, shapes, image sources and duplicate ids', () => {
    const r = { id: 'r', type: 'rect', rect, fill: '#ffffff', shape: 'rectangle' };
    const t = { id: 't', type: 'text', rect, text: 'X', fontSize: 40, weight: 400, align: 'left', color: '#000000', font: 'space-grotesk' };
    for (const n of [null, {}, { ...r, type: 'other' }, { ...r, id: '' }, { ...r, rect: null }, { ...r, rect: { ...rect, w: 0 } }, { ...r, rect: { ...rect, x: NaN } }, { ...r, rect: { ...rect, y: Infinity } }, { ...r, fill: 'red' }, { ...r, shape: 'circle' }, { ...r, shape: undefined }, { ...t, text: 4 }, { ...t, fontSize: -1 }, { ...t, weight: 500 }, { ...t, align: 'justify' }, { ...t, color: '' }, { ...t, font: 'arial' }, { ...t, font: undefined }, { id: 'i', type: 'image', rect, src: 'https://x', naturalSize: { w: 1, h: 1 } }]) expect(validateDocument({ ...create(), nodes: [n] })).toBe(false);
